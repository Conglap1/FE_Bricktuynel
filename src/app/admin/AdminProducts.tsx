...
import { Plus, Pencil, Trash2, X, Save, Upload, Star, Loader2, Image as ImageIcon, Check, Eye } from "lucide-react";
  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-[#560213]" style={{ fontFamily: "var(--font-display)" }}>Sản phẩm</h1>
          <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-[#560213]/70">{products.length} sản phẩm</p>
        </div>
