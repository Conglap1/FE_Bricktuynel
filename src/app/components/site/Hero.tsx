    ...
    <section id="top" ref={ref} className="relative min-h-[100svh] overflow-hidden bg-[#560213]">
      ...
      >
        <motion.div
          ...
          className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-1.5 backdrop-blur-md"
        >
          <span className="h-1.5 w-1.5 rounded-full bg-[#C76B86]" />
          <span className="text-[12px] font-medium uppercase tracking-[0.2em] text-white/90">
            Nhà sản xuất gạch đất nung Tuynel · Từ 1988
          </span>
        </motion.div>
