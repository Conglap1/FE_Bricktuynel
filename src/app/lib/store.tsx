...
export const DEFAULT_ABOUT: AboutData = {
  ...
  desc: "Thành lập năm 1988, Gạch Thuận Lợi là một trong những đơn vị sản xuất gạch đất sét nung Tuynel hàng đầu khu vực phía Nam. Chúng tôi kết hợp dây chuyền công nghệ hiện đại với quy trình chuyên nghiệp để tạo ra những sản phẩm bền vững, an toàn — giao hàng toàn quốc với giá cạnh tranh trực tiếp từ nhà máy.",
  points: [
